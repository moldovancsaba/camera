...
export default async function FunFitFanLandingPage() {
  ...
  return (
    <div className="fff-landing-shell">
      <div className="fff-landing-inner">
        ...
        <p className="fff-landing-footnote">
          ...
          for <code className="fff-landing-code">*.messmass.com</code> keep you signed in across subdomains when
          your team enables that.
        </p>
      </div>
    </div>
  );
