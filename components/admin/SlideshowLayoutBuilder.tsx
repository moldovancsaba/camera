...
export default function SlideshowLayoutBuilder({
  ...
  const previewAlignClass = layoutAlignmentFlexClasses(
    alignVertical,
    alignHorizontal
  );
          ...
          >
            ...
            {background.trim() ? (
              <>
                ...
                />
                <div
                  className="slideshow-layout-builder-root-bg absolute inset-0 z-[1] pointer-events-none rounded-[inherit]"
                  aria-hidden
                />
              </>
            ) : null}
