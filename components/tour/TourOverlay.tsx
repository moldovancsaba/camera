...
export default function TourOverlay({ controller }: { controller: TourController }) {
  ...
  useLayoutEffect(() => {
    ...
    // Some targets (e.g. the shutter button, which only mounts once the
    // camera stream resolves) don't exist yet the instant a step opens --
    // poll briefly before concluding the target genuinely won't appear.
